...
export type CreateOrderItemOption = {
  choices: Array<CreateOrderItemsOptionChoice>;
  name: Scalars['String']['input'];
};

export type CreateOrderItemsOptionChoice = {
  extra: Scalars['Int']['input'];
  name: Scalars['String']['input'];
};
...
export type CreateOrderMutationVariables = Exact<{
  restaurantId: Scalars['Int']['input'];
  items: Array<CreateOrderItem> | CreateOrderItem;
}>;
...
export type MyRestaurantQuery = { __typename?: 'Query', myRestaurant: { __typename?: 'MyRestaurantOutput', ok: boolean, error?: string | null, restaurant?: (
      { __typename?: 'Restaurant', name: string, menu?: Array<(
        { __typename?: 'Dish' }
        & { ' $fragmentRefs'?: { 'DishPartsFragment': DishPartsFragment } }
      )> | null, orders?: Array<(
        { __typename?: 'Order' }
...
export type CreateRestaurantPaymentMutationVariables = Exact<{
  transactionId: Scalars['String']['input'];
  restaurantId?: InputMaybe<Scalars['Int']['input']>;
}>;


export type CreateRestaurantPaymentMutation = { __typename?: 'Mutation', createRestaurantPayment: { __typename?: 'CreateRestaurantPaymentOutput', ok: boolean, error?: string | null } };
...
export const CreateOrderDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"createOrder"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"restaurantId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"items"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateOrderItem"}}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createOrder"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"restaurantId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"restaurantId"}}},{"kind":"Argument","name":{"kind":"Name","value":"items"},"value":{"kind":"Variable","name":{"kind":"Name","value":"items"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"ok"}},{"kind":"Field","name":{"kind":"Name","value":"error"}},{"kind":"Field","name":{"kind":"Name","value":"orderId"}}]}}]}}]} as unknown as DocumentNode<CreateOrderMutation, CreateOrderMutationVariables>;
